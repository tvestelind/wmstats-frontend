...
var $author$project$Main$StatsResponse = function (a) {
...
var $author$project$Main$Stat = F6(
	function (faction, wins, losses, minElo, avgElo, maxElo) {
		return {avgElo: avgElo, faction: faction, losses: losses, maxElo: maxElo, minElo: minElo, wins: wins};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$map6 = _Json_map6;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$decodeStat = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Main$Stat,
	A2($elm$json$Json$Decode$field, 'faction', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'wins', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'losses', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'minElo', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'averageElo', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'maxElo', $elm$json$Json$Decode$int));
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$decodeStats = $elm$json$Json$Decode$list($author$project$Main$decodeStat);
...
var $author$project$Main$getStats = $elm$http$Http$get(
	{
		expect: A2(
			$elm$http$Http$expectJson,
			A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$Main$StatsResponse),
			$author$project$Main$decodeStats),
		url: 'http://localhost:8080/stats'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{stats: $krisajenkins$remotedata$RemoteData$Loading},
...
var $author$project$Main$viewStat = F2(
	function (totalPlayed, stat) {
		var total = stat.wins + stat.losses;
		var winPercentage = (stat.wins / total) * 100;
		var playPercentage = (total / totalPlayed) * 100;
		var eloDifference = stat.maxElo - stat.minElo;
		return A2(
			$elm$html$Html$tr,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(stat.faction)
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(stat.wins))
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(stat.losses))
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($cuducos$elm_format_number$FormatNumber$format, $cuducos$elm_format_number$FormatNumber$Locales$usLocale, winPercentage))
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($cuducos$elm_format_number$FormatNumber$format, $cuducos$elm_format_number$FormatNumber$Locales$usLocale, playPercentage))
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(stat.minElo))
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(stat.avgElo))
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(stat.maxElo))
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(eloDifference))
						]))
				]));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Max - Min ELO')
							]))
					])),
				A2(
				$elm$html$Html$tbody,
